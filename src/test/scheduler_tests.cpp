...
BOOST_AUTO_TEST_CASE(manythreads)
{
    ...
    std::chrono::system_clock::time_point start = boost::chrono::system_clock::now();
    ...
    for (int i = 0; i < 100; i++) {
        std::chrono::system_clock::time_point t = now + boost::chrono::microseconds(randomMsec(rng));
        std::chrono::system_clock::time_point tReschedule = now + boost::chrono::microseconds(500 + randomMsec(rng));
