...
#include "qt/ksoc/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(KSOCGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &KSOCGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
