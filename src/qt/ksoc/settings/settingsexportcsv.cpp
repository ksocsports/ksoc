...
#include "qt/ksoc/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(KSOCGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("KSOC_tx_csv_export(*.csv)") : tr("KSOC_addresses_csv_export(*.csv)"),
                                        nullptr);
