...
#include "qt/ksoc/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ksoc/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(KSOCGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to KSOCGUI::handleRestart()
