...
#include "qt/ksoc/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ksoc/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(KSOCGUI* _window, QWidget *parent) :
