...
#include "qt/ksoc/settings/settingsnetworkwidget.h"
#include "qt/ksoc/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ksoc/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(KSOCGUI* _window, QWidget *parent) :
