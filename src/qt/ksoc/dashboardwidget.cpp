...
#include "qt/ksoc/forms/ui_dashboardwidget.h"
#include "qt/ksoc/sendconfirmdialog.h"
#include "qt/ksoc/txrow.h"
...
DashboardWidget::DashboardWidget(KSOCGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &KSOCGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
...
void DashboardWidget::loadWalletModel()
{
    if (walletModel && walletModel->getOptionsModel()) {
        ...
        connect(ui->pushImgEmpty, &QPushButton::clicked, window, &KSOCGUI::openFAQ);
        connect(ui->btnHowTo, &QPushButton::clicked, window, &KSOCGUI::openFAQ);
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(82,02,12));
    set1->setColor(QColor(64,02,12));
