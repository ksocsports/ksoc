...
// Copyright (c) 2015-2018 The KSOC developers
...
#define QAPP_ORG_NAME "KSOC"
#define QAPP_ORG_DOMAIN "ksoc.org"
#define QAPP_APP_NAME_DEFAULT "KSOC-Qt"
#define QAPP_APP_NAME_TESTNET "KSOC-Qt-testnet"
