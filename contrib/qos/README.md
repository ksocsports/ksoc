...
This means one can have an always-on ksocd instance running, and another local ksocd/ksoc-qt instance which connects to this node and receives blocks from it.
