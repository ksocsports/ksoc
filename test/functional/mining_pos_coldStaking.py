...
from test_framework.ksoc_node import KsocTestNode
...
class KSOC_ColdStakingTest(KsocTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(KsocTestNode())
