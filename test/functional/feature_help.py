...
"""Verify that starting ksoc with -h works as expected."""
import subprocess

from test_framework.test_framework import KsocTestFramework
from test_framework.util import assert_equal

class HelpTest(KsocTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ksoc with -? for help text")
        ...
        self.log.info("Start ksoc with -version for version information")
