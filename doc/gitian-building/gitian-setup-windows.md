...
The build script we'll be using is contained in the KSOC github repository ([contrib/gitian-build.py](https://github.com/ksoc-project/ksoc/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the KSOC repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/KSOC-Project/KSOC/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, ksoc-detached-sigs, and ksoc GitHub repos.
