KSOC Core version *3.1.1* is now available from:  <https://github.com/ksoc-project/ksoc/releases>
...
KSOC Core v3.1.1 is a non-mandatory update to address bugs and introduce minor enhancements that do not require a network change.
...
zPIV stake set to update more frequently and lowering the stake hashdrift to 30 seconds to reduce the number of orphans being experienced by KSOC stakers.
